...
export const REASON_NO_OFFICIAL_AI_API = 'La API v1 de Google Search Console no expone métricas de IA generativa: los enums type (WEB|IMAGE|VIDEO|NEWS|DISCOVER|GOOGLE_NEWS) y dimensions (DATE|QUERY|PAGE|COUNTRY|DEVICE|SEARCH_APPEARANCE|HOUR) no incluyen ningún valor de IA (discovery rev. 20260902). Las impresiones y clics de AI Overviews y AI Mode SÍ existen, pero agregados dentro del tipo de búsqueda WEB.';
...
export class NoAiVisibilityProvider {
    id = 'none';
