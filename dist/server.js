...
export const SERVER_INSTRUCTIONS = 'Keytrends SEO/AEO MCP Server. Proporciona 7 herramientas de análisis SEO y visibilidad en IA respaldadas por la API oficial de Google Search Console y análisis first-party del sitio web. Todas las herramientas devuelven un sobre JSON estructurado con metadatos de procedencia por métrica, nivel de confianza y fecha de recuperación. Las impresiones y clics de AI Overviews y AI Mode están incluidos dentro del tipo de búsqueda WEB; Search Console no los desglosa en su API oficial.';
